...
public class WSQCar  implements java.io.Serializable{
	...
	public void setIdQNcr2(Long idQNcr2) {
		this.idQNcr2 = idQNcr2;
	}
	...
	public String getInterimCorrectiveAction() {
		return interimCorrectiveAction;
	}
	...
	public String getPermanentCorrectiveAction() {
		return permanentCorrectiveAction;
	}
