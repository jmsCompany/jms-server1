...
public class WSQG8d  implements java.io.Serializable{
	...
	public String getImplementedPermanentAction() {
		return implementedPermanentAction;
	}
	...
	public List<WSQG8dUser> getUsers() {
		return users;
	}
