...
public class SecuredObjectService {
	...
	@Autowired private SecurityACLDAO securityACLDAO;
	...
	public Map<String, Object> getSecuredObjectsWithPermissions(
		...
		PermissionEvaluator permissionEvaluator = new AclPermissionEvaluator(mutableAclService);
	...
	public List<AccessControlEntry> getAccessEntries(
			AbstractSecuredEntity element, Class domainClass) {
