...
public interface PUnplannedStopsRepository extends JpaRepository<PUnplannedStops, Long>{
	...
	@Query("select p from PUnplannedStops p where p.PSubCode.idSubCode=?1 and p.PStatusDic.idPstatus=18")
	public List<PUnplannedStops> getByPSubCodeId(Long pSubCodeId);
