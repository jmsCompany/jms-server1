...
import com.jms.repositories.user.ModulesRepository;
...
public class RolePrivService {
	...
	public void loadRolesPrivFromCSV(String fileName) throws IOException{
        ...
        reader.readHeaders();  //Module,Role,Priv
		while(reader.readRecord())
		{
			...
			Roles r =roleRepository.findByRoleAndCompanyName(role, SpecialCompanyEnum.Template_company.toString());
