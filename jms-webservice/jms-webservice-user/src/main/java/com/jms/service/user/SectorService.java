...
import com.jms.repositories.user.SectorsRepository;
...
public class SectorService {
	...
	public void loadSectorsFromCSV(String fileName) throws IOException{
        ...
        reader.readHeaders();  //Role	Description
		while(reader.readRecord())
		{
			...
			s.setCompany(companyRepository.findByCompanyName(SpecialCompanyEnum.Template_company.toString()));
