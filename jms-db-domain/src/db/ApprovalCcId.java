...
/**
 * ApprovalCcId generated by hbm2java
 */
@Embeddable
public class ApprovalCcId  implements java.io.Serializable {
    ...
    public ApprovalCcId(Long idApprovalPhase, Long idUser) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ApprovalCcId) ) return false;
		 ApprovalCcId castOther = ( ApprovalCcId ) other; 
