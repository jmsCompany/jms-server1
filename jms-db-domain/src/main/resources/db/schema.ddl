...
CREATE INDEX XIF1BUY_RECORD ON BUY_RECORD
(
	ID_COMPANY
)
;
...
CREATE INDEX XIF3BUY_RECORD ON BUY_RECORD
(
	ID_RECEIPT
)
;
...
CREATE INDEX XIF4BUY_RECORD ON BUY_RECORD
(
	ID_SERVICE
)
;
...
CREATE INDEX XIF1FEEDBACK ON FEEDBACK
(
	ID_USER
)
;
...
CREATE INDEX XIF4ISSUE ON ISSUE
(
	CREATOR
)
;
...
CREATE INDEX XIF3ISSUE_COMMENT ON ISSUE_COMMENT
(
	CREATOR
)
;
...
CREATE INDEX XIF3ISSUE_DOC ON ISSUE_DOC
(
	ID_ISSUE_COMMENT
)
;
...
CREATE INDEX XIF5PROJECT ON PROJECT
(
	PARENT
)
;
...
CREATE INDEX XIF6PROJECT ON PROJECT
(
	STATUS
)
;
...
CREATE INDEX XIF1RECEIPT ON RECEIPT
(
	ID_COMPANY
)
;
...
CREATE INDEX XIF1SERVICE ON SERVICE
(
	ID_SERVICE_TYPE
)
;
...
CREATE UNIQUE INDEX XPKTASK_PARTICIPANT ON TASK_PARTICIPANT
(
	ID_TASK,
	ID_USER
)
...
CREATE INDEX XIF1TASK_PARTICIPANT ON TASK_PARTICIPANT
(
	ID_TASK
)
;
...
CREATE INDEX XIF2TASK_PARTICIPANT ON TASK_PARTICIPANT
(
	ID_USER
)
;
...
CREATE INDEX XIF9USERS ON USERS
(
	ID_USER
)
;
...
ALTER TABLE USERS
	ADD FOREIGN KEY R_128 (ID_USER) REFERENCES USERS(ID_USER)
;
