...
CREATE TABLE P_PERSONNEL_PLAN
(
	ID_PER_PLAN           INTEGER NULL,
	PER_PLAN_NO           INTEGER NULL,
	NAME                  VARCHAR(64) NULL,
...
ALTER TABLE P_PERSONNEL_PLAN
	ADD  PRIMARY KEY (ID_PER_PLAN)
;



CREATE TABLE P_PERSONNEL_PLAN_D
(
	ID_PERSONNEL_D        INTEGER NULL,
	SHIFT                 VARCHAR(20) NULL,
	ID_PER_PLAN           INTEGER NULL,
	DES                   VARCHAR(1024) NULL,
	ST                    DATE NULL,
...
ALTER TABLE P_PERSONNEL_PLAN_D
	ADD  PRIMARY KEY (ID_PERSONNEL_D)
;
...
ALTER TABLE P_STATUS
	ADD  PRIMARY KEY (ID_PSTATUS_DIC)
;
...
(
	...
	EMP_MT                INTEGER NULL,
	DATE_MT               TIMESTAMP NULL,
	FROM_STK              INTEGER NULL,
	TO_STK                INTEGER NULL,
	_default_             CHAR(18) NULL,
	_default___5353       CHAR(18) NULL,
	ID_COMPANY            INTEGER NULL,
	ID_SCHEDULE           INTEGER NULL,
	STATUS                INTEGER NULL
)
...
(
	...
	_default___4917       CHAR(18) NULL,
	OP_DES                VARCHAR(128) NULL,
	ID_SUB_CODE           INTEGER NULL,
	REASON                VARCHAR(1024) NULL,
	REACTION              VARCHAR(1024) NULL,
	UNPLANNED_ST__5077    DATE NULL
)
;
...
ALTER TABLE P_BOM
	ADD FOREIGN KEY R_331 (ID_MAT) REFERENCES S_MATERIAL(ID)
;
...
ALTER TABLE P_BOM_LABEL
	ADD FOREIGN KEY R_328 (ID_PSTATUS_DIC) REFERENCES P_STATUS(ID_PSTATUS_DIC)
;
...
ALTER TABLE P_BOM_LABEL
	ADD FOREIGN KEY R_431 (ID_BOM) REFERENCES P_BOM(ID_BOM)
;
...
ALTER TABLE P_C_PP
	ADD FOREIGN KEY R_437 (ID_S_PP) REFERENCES P_S_PP(ID_S_PP)
;
...
ALTER TABLE P_DISPATCH
	ADD FOREIGN KEY R_421 (ID_LOT_NO) REFERENCES S_INCOME_LOT_NO(ID_LOT_NO)
;


ALTER TABLE P_DISPATCH
	ADD FOREIGN KEY R_430 (ID_MTF_MAT) REFERENCES S_MTF_MATERIAL(ID)
;
...
ALTER TABLE P_PA
	ADD FOREIGN KEY R_351 (ID_PSTATUS_DIC) REFERENCES P_STATUS(ID_PSTATUS_DIC)
;


ALTER TABLE P_PA
	ADD FOREIGN KEY R_438 (ID_WO) REFERENCES P_WO(ID_WO)
;



ALTER TABLE P_PA_LINE
	ADD FOREIGN KEY R_353 (ID_C_PP) REFERENCES P_C_PP(ID_C_PP)
;


ALTER TABLE P_PA_LINE
	ADD FOREIGN KEY R_354 (OPRATOR) REFERENCES USERS(ID_USER)
;



ALTER TABLE P_PERSONNEL_PLAN
	ADD FOREIGN KEY R_359 (ID_PSTATUS_DIC) REFERENCES P_STATUS(ID_PSTATUS_DIC)
;
...
ALTER TABLE P_PERSONNEL_PLAN_D
	ADD FOREIGN KEY R_360 (ID_PER_PLAN) REFERENCES P_PERSONNEL_PLAN(ID_PER_PLAN)
;
...
ALTER TABLE P_PROGRAM_SCHEDULE
	ADD FOREIGN KEY R_424 (ID_USER) REFERENCES USERS(ID_USER)
;


ALTER TABLE P_PROGRAM_SCHEDULE
	ADD FOREIGN KEY R_425 (ID_C_PP) REFERENCES P_C_PP(ID_C_PP)
;


ALTER TABLE P_PROGRAM_SCHEDULE
	ADD FOREIGN KEY R_426 (ID_MACHINE) REFERENCES P_MACHINE(ID_MACHINE)
;



ALTER TABLE P_ROUTINE
	ADD FOREIGN KEY R_334 (ID_MAT) REFERENCES S_MATERIAL(ID)
;


ALTER TABLE P_ROUTINE
	ADD FOREIGN KEY R_336 (ID_PSTATUS_DIC) REFERENCES P_STATUS(ID_PSTATUS_DIC)
;
...
ALTER TABLE P_S_PP
	ADD FOREIGN KEY R_436 (ID_PSTATUS_DIC) REFERENCES P_STATUS(ID_PSTATUS_DIC)
;



ALTER TABLE P_STOPS_PLAN
	ADD FOREIGN KEY R_347 (ID_MACHINE) REFERENCES P_MACHINE(ID_MACHINE)
;


ALTER TABLE P_STOPS_PLAN
	ADD FOREIGN KEY R_348 (ID_STOPS_CODE) REFERENCES P_STOPS_CODE(ID_STOPS_CODE)
;
...
ALTER TABLE P_STOPS_PLAN
	ADD FOREIGN KEY R_358 (ID_PSTATUS_DIC) REFERENCES P_STATUS(ID_PSTATUS_DIC)
;
...
ALTER TABLE S_BIN
	ADD FOREIGN KEY R_389 (IS_RETURN_SHELF) REFERENCES YES_OR_NO_DIC(ID)
;
...
ALTER TABLE S_DO
	ADD FOREIGN KEY R_409 (ID_CO_COMPANY) REFERENCES S_COMPANY_CO(ID)
;
...
ALTER TABLE S_DO_MATERIAL
	ADD FOREIGN KEY R_401 (ID_SO) REFERENCES S_SO(ID_SO)
;
...
ALTER TABLE S_INCOME
	ADD FOREIGN KEY R_379 (ID_PO_MATERIAL) REFERENCES S_PO_MATERIAL(ID)
;



ALTER TABLE S_INCOME_LOT_NO
	ADD FOREIGN KEY R_322 (STATUS_INSPECTION) REFERENCES S_STATUS_DIC(ID)
;


ALTER TABLE S_INCOME_LOT_NO
	ADD FOREIGN KEY R_396 (ID_R) REFERENCES S_INCOME(ID_R)
;


ALTER TABLE S_INCOME_LOT_NO
	ADD FOREIGN KEY R_398 (ID_BIN) REFERENCES S_BIN(ID_BIN)
;


ALTER TABLE S_INCOME_LOT_NO
	ADD FOREIGN KEY R_417 (STATUS) REFERENCES S_STATUS_DIC(ID)
;
...
ALTER TABLE S_MRB
	ADD FOREIGN KEY R_399 (ID_LOT_NO) REFERENCES S_INCOME_LOT_NO(ID_LOT_NO)
;


ALTER TABLE S_MRB
	ADD FOREIGN KEY R_403 (STATUS) REFERENCES S_STATUS_DIC(ID)
;
...
ALTER TABLE S_MTF
	ADD FOREIGN KEY R_429 (ID_SCHEDULE) REFERENCES P_PROGRAM_SCHEDULE(ID_SCHEDULE)
;
...
ALTER TABLE S_MTF_MAT_LOT_NO
	ADD FOREIGN KEY R_428 (ID_MTF_MAT) REFERENCES S_MTF_MATERIAL(ID)
;
...
ALTER TABLE S_RMA
	ADD FOREIGN KEY R_404 (STAUTS) REFERENCES S_STATUS_DIC(ID)
;


ALTER TABLE S_RMA
	ADD FOREIGN KEY R_410 (ID_DO_MATERIAL) REFERENCES S_DO_MATERIAL(ID)
;
...
ALTER TABLE S_SO
	ADD FOREIGN KEY R_400 (MATERIAL) REFERENCES S_MATERIAL(ID)
;
