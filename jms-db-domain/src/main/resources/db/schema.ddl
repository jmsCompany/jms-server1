...
CREATE UNIQUE INDEX XPKA_APPLICATION ON A_APPLICATION
(
	ID_APPLICATION
)
;
...
CREATE UNIQUE INDEX XPKA_APPLICATION_PHASE ON A_APPLICATION_PHASE
(
	ID_APPLICATION,
	ID_APPROVAL_PHASE
)
...
CREATE UNIQUE INDEX XPKA_APPROVAL_CC ON A_APPROVAL_CC
(
	ID_APPROVAL_PHASE,
	ID_USER
)
...
CREATE UNIQUE INDEX XPKA_APPROVAL_PHASE ON A_APPROVAL_PHASE
(
	ID_APPROVAL_PHASE
)
;
...
CREATE UNIQUE INDEX XPKA_APPROVAL_PROCESS ON A_APPROVAL_PROCESS
(
	ID_APPROVAL_PROCESS
)
;
...
CREATE UNIQUE INDEX XPKA_APPROVAL_TYPE ON A_APPROVAL_TYPE
(
	ID_APPROVAL_TYPE
)
;
...
CREATE UNIQUE INDEX XPKAPPS ON APPS
(
	ID_APP
)
;
...
CREATE UNIQUE INDEX XPKBUY_RECORD ON BUY_RECORD
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKC_REPEATS ON C_REPEATS
(
	ID_REPEAT
)
;
...
CREATE UNIQUE INDEX XPKC_SCHEDULE ON C_SCHEDULE
(
	ID_SCHEDULE
)
;
...
CREATE UNIQUE INDEX XPKC_SCHEDULE_DOC ON C_SCHEDULE_DOC
(
	ID_SCHEDULE,
	ID_DOCUMENT
)
...
CREATE UNIQUE INDEX XPKC_SCHEDULE_WATCHER ON C_SCHEDULE_WATCHER
(
	ID_USER,
	ID_SCHEDULE
)
...
CREATE UNIQUE INDEX XPKFEEDBACK ON FEEDBACK
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKP_POLL ON P_POLL
(
	ID_POLL
)
;
...
CREATE UNIQUE INDEX XPKP_POLL_ITEMS ON P_POLL_ITEMS
(
	ID_ITEM
)
;
...
CREATE UNIQUE INDEX XPKP_POLL_PARTICIPANT ON P_POLL_PARTICIPANT
(
	ID_PARTICIPANT
)
;
...
CREATE UNIQUE INDEX XPKP_VOTE ON P_VOTE
(
	ID_PARTICIPANT,
	ID_ITEM
)
...
CREATE UNIQUE INDEX XPKRECEIPT ON RECEIPT
(
	ID_RECEIPT
)
;
...
CREATE UNIQUE INDEX XPKRECEIVER ON RECEIVER
(
	ID_RECEIVER
)
;
...
CREATE UNIQUE INDEX XPKS_ATTACHMENT ON S_ATTACHMENT
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_BIN ON S_BIN
(
	ID_STK,
	BIN
)
...
CREATE UNIQUE INDEX XPKS_COMPANY_CO ON S_COMPANY_CO
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_COMPANY_CO_ATTACHMENT ON S_COMPANY_CO_ATTACHMENT
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_COUNTRY_DIC ON S_COUNTRY_DIC
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_DO ON S_DO
(
	ID_DO
)
;
...
CREATE UNIQUE INDEX XPKS_DO_MATERIAL ON S_DO_MATERIAL
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_GENDER_DIC ON S_GENDER_DIC
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_INCOME ON S_INCOME
(
	ID_R
)
;
...
CREATE UNIQUE INDEX XPKS_INCOME_MATERIAL ON S_INCOME_MATERIAL
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_INVENTORY ON S_INVENTORY
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_LEVEL_DIC ON S_LEVEL_DIC
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_LINKMAN ON S_LINKMAN
(
	ID,
	NAME
)
...
CREATE UNIQUE INDEX XPKS_MATERIAL ON S_MATERIAL
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_MATERIAL_ATTACHMENT ON S_MATERIAL_ATTACHMENT
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_MATERIAL_BIN ON S_MATERIAL_BIN
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_MATERIAL_CATEGORY ON S_MATERIAL_CATEGORY
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_MATERIAL_CATEGORY_PIC ON S_MATERIAL_CATEGORY_PIC
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_MATERIAL_PIC ON S_MATERIAL_PIC
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_MATERIAL_TYPE_DIC ON S_MATERIAL_TYPE_DIC
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_MTF ON S_MTF
(
	ID_MT
)
;
...
(
	...
	MATERIAL              INTEGER NULL,
	QTY                   NUMERIC NULL,
	QTY__3823             INTEGER NULL
)
;



CREATE UNIQUE INDEX XPKS_MTF_MATERIAL ON S_MTF_MATERIAL
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_PIC ON S_PIC
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_PIC_SETTING ON S_PIC_SETTING
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_PO ON S_PO
(
	ID_PO
)
;
...
CREATE UNIQUE INDEX XPKS_PO_MATERIAL ON S_PO_MATERIAL
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_SO ON S_SO
(
	ID_SO
)
;
...
CREATE UNIQUE INDEX XPKS_SO_MATERIAL ON S_SO_MATERIAL
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_STATUS_DIC ON S_STATUS_DIC
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_STK ON S_STK
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_TERM_DIC ON S_TERM_DIC
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_TYPE_DIC ON S_TYPE_DIC
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKS_UNIT_DIC ON S_UNIT_DIC
(
	ID
)
;
...
CREATE UNIQUE INDEX XPKService_Type ON Service_Type
(
	ID_SERVICE_TYPE
)
;
...
CREATE UNIQUE INDEX XPKW_ISSUE ON W_ISSUE
(
	ID_ISSUE
)
;
...
CREATE UNIQUE INDEX XPKW_ISSUE_COMMENT ON W_ISSUE_COMMENT
(
	ID_ISSUE_COMMENT
)
;
...
CREATE UNIQUE INDEX XPKW_ISSUE_DOC ON W_ISSUE_DOC
(
	ID_ISSUE,
	ID_DOCUMENT
)
...
CREATE UNIQUE INDEX XPKW_PROJECT ON W_PROJECT
(
	ID_PROJECT
)
;
...
CREATE UNIQUE INDEX XPKW_PROJECT_DOC ON W_PROJECT_DOC
(
	ID_PROJECT,
	ID_DOCUMENT
)
...
CREATE UNIQUE INDEX XPKW_PROJECT_PARTICIPANT ON W_PROJECT_PARTICIPANT
(
	ID_PROJECT,
	ID_USER
)
...
CREATE UNIQUE INDEX XPKW_TASK ON W_TASK
(
	ID_TASK
)
;
...
CREATE UNIQUE INDEX XPKW_TASK_COMMENT ON W_TASK_COMMENT
(
	ID_COMMENT
)
;
...
CREATE UNIQUE INDEX XPKW_TASK_DOC ON W_TASK_DOC
(
	ID_TASK,
	ID_DOCUMENT
)
...
CREATE UNIQUE INDEX XPKW_TASK_PARTICIPANT ON W_TASK_PARTICIPANT
(
	ID_TASK,
	ID_USER
)
...
ALTER TABLE A_APPLICATION
	ADD FOREIGN KEY R_176 (PRIVOUS_APPLICATION) REFERENCES A_APPLICATION(ID_APPLICATION)
;
...
ALTER TABLE P_VOTE
	ADD FOREIGN KEY R_146 (ID_PARTICIPANT) REFERENCES P_POLL_PARTICIPANT(ID_PARTICIPANT)
;
